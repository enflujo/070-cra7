// Tomado de: https://cdnjs.cloudflare.com/ajax/libs/Blotter/0.1.0/materials/channelSplitMaterial.min.js en noviembre de 2024
!(function (e) {
  (e.ChannelSplitMaterial = function () {
    e.Material.apply(this, arguments);
  }),
    (e.ChannelSplitMaterial.prototype = Object.create(e.Material.prototype)),
    e._extendWithGettersSetters(e.ChannelSplitMaterial.prototype, {
      constructor: e.ChannelSplitMaterial,
      init: function () {
        (this.mainImage = [
          e.Assets.Shaders.PI,
          e.Assets.Shaders.LineMath,
          e.Assets.Shaders.Random,
